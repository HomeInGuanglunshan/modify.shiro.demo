package modify.shiro.demo.core.shiro.config;
...
import modify.shiro.demo.core.shiro.CustomShiroSessionDAO;
import modify.shiro.demo.core.shiro.cache.JedisShiroSessionRepository;
import modify.shiro.demo.core.shiro.cache.impl.CustomShiroCacheManager;
import modify.shiro.demo.core.shiro.filter.KickoutSessionFilter;
import modify.shiro.demo.core.shiro.filter.LoginFilter;
import modify.shiro.demo.core.shiro.filter.PermissionFilter;
import modify.shiro.demo.core.shiro.filter.RoleFilter;
import modify.shiro.demo.core.shiro.filter.SimpleAuthFilter;
import modify.shiro.demo.core.shiro.listenter.CustomSessionListener;
import modify.shiro.demo.core.shiro.token.SampleRealm;
...
//		sessionValidationScheduler.setInterval(1800000);
	...
	public MethodInvokingFactoryBean injectJedisShiroSessionRepositoryIntoKickoutSessionFilter(
		...
		methodInvokingFactoryBean
				.setStaticMethod("modify.shiro.demo.core.shiro.filter.KickoutSessionFilter.setShiroSessionRepository");
