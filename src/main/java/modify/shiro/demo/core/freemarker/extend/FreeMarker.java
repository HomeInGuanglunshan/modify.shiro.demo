...
import modify.shiro.demo.common.utils.SpringContextUtil;
import modify.shiro.demo.common.utils.StringUtils;
import modify.shiro.demo.common.utils.UtilPath;
import modify.shiro.demo.core.tags.APITemplateModel;
...
//		initMap.put("path", path);
		...
		FreeMarkerConfigExtension ext = SpringContextUtil.getBean("freemarkerConfig",FreeMarkerConfigExtension.class);
		...
		try {
			FreeMarkerConfigExtension.putInitShared(cfg);
